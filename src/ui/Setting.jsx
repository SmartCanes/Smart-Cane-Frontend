...
const ToggleItem = ({ icon, title, description, checked, onChange }) => (
  <div className="flex items-center justify-between py-4">
    <div className="flex items-center gap-4">
      ...
      <div>
        <h4 className="text-sm font-bold text-[#11285A] font-poppins">{title}</h4>
        <p className="text-xs text-gray-500 font-poppins mt-0.5">{description}</p>
      </div>
    </div>
    <button
      onClick={onChange}
          ...
          <div className="w-full font-poppins">
             ...
             <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-[#11285A]">Notification Preferences</h3>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-[#11285A]">Privacy & Security</h3>
                    <p className="text-sm text-gray-500 mt-1">Control your data and security preferences</p>
                  </div>
