          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 text-gray-700">
              <div className="space-y-4">
                <section>
                  <h3 className="text-lg font-semibold font-poppins text-gray-900 mb-2"> Acceptance of Terms</h3>
...
<section>
                  ...
                  <label className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors">
                    ...
                    <span className="text-sm font-poppins text-gray-700 select-none">
                        I confirm that the Terms and Conditions have been read and explained to me in a language I understand. I voluntarily assume the risks associated with using this prototype device.
                    </span>
                  </label>
